local function oeffneOrdner()
  ...
  inputText = displayTextBoxMessage("Ordnernamen eingeben:", "Es sind nur einfache Zeichen erlaubt!", "01-Studium")
  hs.execute("open " .. os.getenv("HOME") .."/" .. dir .. "/" .. inputText)
end
-- return inputText
...
--end
hs.hotkey.bind({"cmd", "alt", "ctrl"}, "4", "Ordner öffnen", oeffneOrdner)
